batsAdminHome.controller('dashboardController', function($scope, $rootScope,$localStorage,$location,$document, $anchorScroll,$interval,commonAppService){
	...
	$scope.getTripData=function(){
		commonAppService.tracker(function(result){
			...
			var data=[{name: "Allocated",y: $scope.TrackerCount.allocated, color: '#008cdc'},
 ...
 *  * 
 * */
batsAdminHome.controller('dashboardTripController', function($scope, $rootScope,$localStorage,commonAppService,$interval,commonFactory){
	$interval.cancel($rootScope.callAlarmApi);
    var requestTime = 12;
	$scope.hideTripTable=true;
	var map;
 ...
 *  * 
 * */
batsAdminHome.controller('dashboardDriverController', function($scope, $rootScope ,$localStorage, $interval, commonAppService){
	$interval.cancel($rootScope.callAlarmApi);

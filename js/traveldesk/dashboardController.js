batstravelDeskHome.controller('dashboardController', function($scope, $interval, $rootScope, $localStorage,$location,commonAppService){
 ...
 *  * 
 * */
batstravelDeskHome.controller('dashboardTripController', function($scope, $rootScope,$localStorage,$interval,commonAppService,commonFactory){
	$interval.cancel($rootScope.callAlarmApi);
	$scope.hideTripTable=true;
	var requestTime = 12;
	var map;
 ...
 *  * 
 * */
batstravelDeskHome.controller('dashboardDriverController', function($scope, $rootScope, $interval, $localStorage, commonAppService) {
	$interval.cancel($rootScope.callAlarmApi);
